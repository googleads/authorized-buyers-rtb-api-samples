...
"""This example sets the status of a specified user list to OPEN."""
...
def main(realtimebidding, args):
  ...
  print(f'Opening userList "{user_list_id}" for buyer account ID '
        f'"{account_id}":')
  try:
    # Construct and execute the request.
    response = (realtimebidding.buyers().userLists().open(
...
if __name__ == '__main__':
  ...
  parser = argparse.ArgumentParser(
      description=('Sets the specified user list\'s status to OPEN.')
  )
  ...
  parser.add_argument(
      ...
      help=('The resource ID of the buyers resource under which the '
            ...
            'name used as a path parameter for the userlists.open request.'))
  parser.add_argument(
