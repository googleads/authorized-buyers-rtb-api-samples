...
"""This example suspends a specified pretargeting config."""
...
def main(realtimebidding, account_id, pretargeting_config_id):
  ...
  print('Suspending a PretargetingConfig with name: "%s".'
        % pretargeting_config_name)
  try:
    response = realtimebidding.bidders().pretargetingConfigs().suspend(
...
if __name__ == '__main__':
  ...
  parser = argparse.ArgumentParser(
      description=('Suspends a specified pretargeting configuraton.'))
  # Required fields.
  parser.add_argument(
