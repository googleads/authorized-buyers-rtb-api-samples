...
{
    /// <summary>
    /// Suspends a pretargeting configuration with a specified name.
    /// </summary>
    public class SuspendPretargetingConfigs : ExampleBase
    {
        ...
        {
            get => "This code example suspends a specified pretargeting configuration";
        }
        ...
        protected override void Run(Dictionary<string, object> parsedArgs)
        {
            ...
            BiddersResource.PretargetingConfigsResource.SuspendRequest request =
                rtbService.Bidders.PretargetingConfigs.Suspend(
                    new SuspendPretargetingConfigRequest(), name);

            PretargetingConfig response = null;

            Console.WriteLine("Suspending pretargeting configuration with name: '{0}'", name);
