...
public class CreateHtmlCreatives {
  ...
  public static void main(String[] args) {
    ArgumentParser parser = ArgumentParsers.newFor("CreateHtmlCreatives").build()
        .defaultHelp(true)
