 ...
 *
 * <p>Note that this is the only way to append URLs following a pretargeting configuration's
 * creation. If a pretargeting configuration already targets URLs, you must specify a targeting mode
 * that is identical to the existing targeting mode.
 */
public class AddTargetedSites {

  public static void execute(RealTimeBidding client, Namespace parsedArgs) throws IOException {
    String pretargetingConfigNme =
        String.format(
    ...
    System.out.printf(
        "Updating web targeting with new site URLs for pretargeting configuration "
            + "with name: '%s'\n",
    ...
    PretargetingConfig pretargetingConfig =
        client
            .bidders()
            .pretargetingConfigs()
            .addTargetedSites(pretargetingConfigNme, body)
            .execute();
  ...
  public static void main(String[] args) {
    ArgumentParser parser =
        ArgumentParsers.newFor("AddTargetedSites")
            .build()
            .defaultHelp(true)
    ...
    parser
        ...
        .help(
            "The targeting mode for this configuration's web targeting. Valid values include:"
                + " INCLUSIVE, and EXCLUSIVE. Note that if the configuration already targets URLs,"
                + " you must specify an identical targeting mode.")
        .required(true)
        .type(String.class);
    parser
