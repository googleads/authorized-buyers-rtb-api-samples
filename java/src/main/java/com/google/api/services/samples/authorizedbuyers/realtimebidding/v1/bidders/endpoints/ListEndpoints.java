...
public class ListEndpoints {
  ...
  public static void execute(RealTimeBidding client, Namespace parsedArgs) {
    ...
    do {
      ...
      try {
        ListEndpointsResponse response = client.bidders().endpoints().list(parent)
  ...
  public static void main(String[] args) {
    ArgumentParser parser = ArgumentParsers.newFor("ListBidders").build()
        .defaultHelp(true)
    ...
    parser.addArgument("-a", "--account_id")
        .help("The resource ID of the bidders resource under which the endpoint exists. This " +
            "will be used to construct the name used as a path parameter for the endpoints.list " +
            "request.")
        .required(true)
        .type(Integer.class);
